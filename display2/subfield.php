...
$otherSubf = mysql_query("SELECT * FROM wg_subfield WHERE id!=$subfield");
$toRemove = array();
...
<link rel="stylesheet" type="text/css" href="<?php echo $realRoot; ?>css/subfield.css">
<body>
<br /><br />
...
<script type="text/javascript">
	...
	while($fi = mysql_fetch_array($f)) echo "color[".$fi['id']."] = '".array_shift($colArray)."';\n";
	?>
