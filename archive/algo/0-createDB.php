...
mysql_query("CREATE TABLE IF NOT EXISTS `wg_category` ( `id` int(100) NOT NULL AUTO_INCREMENT, `name` text CHARACTER SET utf32 COLLATE utf32_bin NOT NULL, `fields` text NOT NULL, `parent` int(100) NOT NULL, `distance` int(10) NOT NULL, `killBranch` int(10) NOT NULL,  PRIMARY KEY (`id`)) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=1;");
...
mysql_query("CREATE TABLE IF NOT EXISTS `wg_page` (`id` int(11) NOT NULL AUTO_INCREMENT, `name` text CHARACTER SET utf32 COLLATE utf32_bin NOT NULL, `category` int(11) NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=1;");

// wg_link : links between two articles to create a graph
mysql_query("CREATE TABLE IF NOT EXISTS `wg_link` (`id` int(100) NOT NULL AUTO_INCREMENT, `from` int(100) NOT NULL, `to` int(100) NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=1;");
...
mysql_query("CREATE TABLE IF NOT EXISTS `wg_redirect` (`id` int(11) NOT NULL AUTO_INCREMENT, `fromName` text CHARACTER SET utf32 COLLATE utf32_bin NOT NULL, `toName` text CHARACTER SET utf32 COLLATE utf32_bin NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1;");
?>