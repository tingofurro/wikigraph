...
<body>
	<div id="leftMenu" onmouseover="menuOver();" onmouseout="menuOut();">
		<?php
		...
		while($fi = mysql_fetch_array($f)) {
			...
			echo "<a class='fieldClick' target='graphIframe' href='".$realRoot."graphArt/".$fi['id']."'>";
	...
	<iframe src="<?php echo $realRoot; ?>graphArt/1" name="graphIframe" id="graphIframe"></iframe>
