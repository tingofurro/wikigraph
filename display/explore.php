...
<head>
	...
	<meta charset="UTF-8" />
		...
		<link rel="stylesheet" type="text/css" href="<?php echo $realRoot; ?>css/displayExplore.css">
	...
	<script type="text/javascript" src="<?php echo $realRoot; ?>JS/viewPage.js"></script>
</html>
<?php
}
?>